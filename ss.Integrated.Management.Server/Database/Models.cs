...
public class Models
{
    ...
    public class MatchRoom
    {
        ...
        [Column("round_id")] public int? RoundId { get; set; }

        [Column("team_red_id")] public int? TeamRedId { get; set; }

        [Column("team_blue_id")] public int? TeamBlueId { get; set; }

        [Column("team_red_points")] public int? TeamRedScore { get; set; }

        [Column("team_blue_points")] public int? TeamBlueScore { get; set; }
        ...
        [Column("winner_to_match_id")] public string? WinnerToMatchId { get; set; }

        [Column("loser_to_match_id")] public string? LoserToMatchId { get; set; }
        ...
        [ForeignKey("RoundId")] public virtual Round Round { get; set; }

        [ForeignKey("TeamRedId")] public virtual User TeamRed { get; set; }

        [ForeignKey("TeamBlueId")] public virtual User TeamBlue { get; set; }

        [ForeignKey("RefereeId")] public virtual RefereeInfo Referee { get; set; }
    }
    ...
    public class QualifierRoom
    {
        ...
        [Column("referee_id")] public int? RefereeId { get; set; }
        ...
        [Column("is_approved")] public bool? Approved { get; set; }

        [Column("mp_link_id")] public int? MpLinkId { get; set; }

        [ForeignKey("RefereeId")] public virtual RefereeInfo Referee { get; set; }

        [ForeignKey("RoundId")] public virtual Round Round { get; set; }

        [ForeignKey("RequestedBy")] public virtual User RequestUser { get; set; }
    }
    ...
    public class Round
    {
        ...
        [Column("ban_mode")] public BansType Mode { get; set; }
    ...
    public class User
    {
        ...
        [Column("osu_id")] public int OsuID { get; set; }

        [Column("discord_id")] public string? DiscordID { get; set; }

        [ForeignKey("OsuID")] public virtual OsuUser OsuData { get; set; }

        [NotMapped] public string DisplayName => OsuData.Username ?? "Desconocido";
    }
    ...
    public class OsuUser
    {
        ...
        [Column("global_rank")] public int GlobalRank { get; set; }

        [Column("country_rank")] public int CountryRank { get; set; }
    }
    ...
    public class Player
    {
        ...
        [Column("qualifier_room_id")] public string? QualifierRoomId { get; set; }

        [ForeignKey("UserId")] public virtual User User { get; set; }

        [ForeignKey("QualifierRoomId")] public virtual QualifierRoom? QualifierRoom { get; set; }
    }
    ...
    public class RefereeInfo
    {
        ...
        [Column("irc_password")] public string IRC { get; set; }
    }
    ...
    public class ScoreResults
    {
        ...
        [ForeignKey("UserId")] public User Team { get; set; }

        [ForeignKey("RoundId")] public Round Round { get; set; }
    }
